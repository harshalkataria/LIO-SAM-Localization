...
public:
    ...
    mapOptimization()
    {
        ...
        subCloud = nh.subscribe<lio_sam_localization::cloud_info>("lio_sam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
